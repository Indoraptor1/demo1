...
public interface DateChooserBean {
     ...
     * @throws datechooser.model.exeptions.IncompatibleDataExeption When default
     * period includes forbidden dates.
     * @since 1.0
     */
     ...
     * @see datechooser.model.multiple.PeriodSet
     * @see datechooser.model.exeptions.IncompatibleDataExeption
     * @throws datechooser.model.exeptions.IncompatibleDataExeption If you are
     * trying to forbid default date.<br>
     * @since 1.0
     */
     ...
     * Selected date.
     *
     * @return Selected date. First date if some dates or period(s) selected
     * @since 1.0
     */
    ...
    /**
     * If true component automatically scrolls when date from the next month
     * selected, otherwise user can not select next month's date.<br>
     * cccc cccccc cccccccc ccccccc, ccccccccc ccccccccccccc cccccccccccccc ccc
     * cccccc cccc cc ccccccccc cccccc, ccccc ccccc ccc cc ccccccccc cccccc cc
     * ccccccccccc.
     *
     * @since 1.0
     */
    ...
    /**
     * If true - you can use calendar only in readonly mode, you can move
     * cursor, scroll month and year, but can not select anything.
     *
     * @since 1.0
     */
    boolean isLocked();
    ...
    /**
     * If true - days of next month are visible. Does not influence scroll
     * property. cc ccccccccc ccc cccccccc ccccc cc cccccc.
     *
     * @since 1.0
     */
