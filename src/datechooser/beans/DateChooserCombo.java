 ...
 *
 * Created on 13 ccccccc 2006 c., 13:37
 *
 */
 ...
 * ccccccccc: "ccccccccccccc cccccccc cccc"
 *
...
public class DateChooserCombo extends DateChooserVisual {
     ...
     * ccccccccc c ccccccccc cccc ccccccc ccccccccccccccc ccccccccc.
     *
     * @since 1.0
     */
...
//        bShowPopup.setBorderPainted(false);
     ...
     * cccccccccc ccccccccc cccc c cccc cccccc c cccccccc ccccccc.
     *
     * @see DateChooserCombo#getFormat()
     * @return Selected date(s) in text format.<br>
     * ccccccccc cccc c ccccccccc ccccccc.
     */
     ...
     * selection      behavior<br><br><CODE>
     *        dateChooserCombo.setBehavior(MultyModelBehavior.SELECT_SINGLE);<br>
     * dateChooserCombo.setText("");
     * </CODE><br><br>
     * ccccccccccccc cccc cc cccccccccc ccccccccccccc. ccccccccccc ccccccccccccc
     * cccccc. cccccccc cccccc ccc cccccccccc cccccc.
     *
     * @param text Text to set. Null or empty string selects empty date.<br>
     * ccccc c ccccc. Null ccc cccccc cccccc ccccccccc ccccccc cccccc ccccc (cc
     * ccccccc cc ccccc cccc)
     * @return True if date was successfully set.<br>
     * cccccc cccc cccccccc cccc cccc ccccccc ccccccccccc.
     * @see DateChooserCombo#getFormat()
    ...
    /**
     * Date field font.<br>
     * ccccc cccc, c ccccccc ccccccccc cccc.
     *
     * @since 1.0
     */
    ...
    public void setCurrentNavigateIndex(int currentNavigateIndex) {
        if (currentNavigateIndex != 1) {
            //ccc cccccc cccccc ccccccccc cccccccc ccc cccccc cccccc -
            //cccc ccccccccccc :(
            return;
        }
     ...
     * ccccccccccccccccc ccccccc. cccc ccccccccccc cc null - ccccccccc c ccccccc
     * cccccc setFormat (c cccccc c ccc cccccccccc ccccccccc ccccc cccccccc)
     * ccccc cccccccccccccc. c ccccccccc ccccccc cccccccc cccccc ccccccc ccccc
     * ccccc cccccccccccc ccccccccc.
     *
     * @since 1.1
     */
     ...
     * ccccccccccccccccc ccccccc. ccccccccc cccccccccc cccccc cccccc c ccccc
     * cccc. cccc ccccccccccc cc null - ccccccccc c ccccccc cccccc setFormat (c
     * cccccc c ccc cccccccccc ccccccccc ccccc cccccccc) ccccc cccccccccccccc.
     * cccccccccc null ccccc ccccc setFormat ccccccccc cc-ccccccc.
     *
     * @since 1.1
     */
